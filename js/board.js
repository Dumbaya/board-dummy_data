function comment_upd_openPopup(tmp_num_mb, t_bcid){
	...
	var popupURL = "http://{도메인}/page/board/board_comment_update.htm?bcid="+tmp_bcid+"&tmp_num="+tmp_num_mb;
...
function ccomment_write_openPopup(tmp_num_mb, t_bcid, t_group){
	...
	var popupURL = "http://{도메인}/page/board/board_ccomment_write.htm?bcid="+tmp_bcid+"&tmp_num="+tmp_num_mb+"&group_id="+tmp_group;
